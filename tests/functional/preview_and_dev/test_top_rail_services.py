...
def test_report_a_problem(driver):
    ...
    assert report_problem_page.is_page_header("Report a problem")
    ...
    assert report_problem_page.is_page_header("Thanks for contacting us")
...
def test_question_or_feedback(driver):
    ...
    assert feedback_page.is_page_header("Ask a question or give feedback")
    ...
    assert feedback_page.is_page_header("Thanks for contacting us")
